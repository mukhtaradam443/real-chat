...
//   const [showSeccessState, setShowSeccessState] = useState<boolean>(false);
...
//       {showSeccessState ? (
//         <p className="mt-1 text-sm text-green-600 ">Friend requests send</p>
//       ) : null}
//     </form>
//   );
// };
